...
\end{theorem}
\begin{example}\nl
	Shift operator \func{T_\lambda}{\ell^2}{\ell^2} ctd. is compact $\iff \lim_{k\to\infty}\lambda_k=0$, self-adjoint $\iff \lambda_k\in\real\,\forall k$, and we know $\sigma_p(T_\lambda)=\overline{\{\lambda_k:k\in\natu\}}$.
\end{example}
